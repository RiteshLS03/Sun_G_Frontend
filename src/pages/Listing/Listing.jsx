    ...
    <div className='listingData'>
        <div className='row'>
            {/* <div className={`col-md-3 sidebarWrapper ${context.isOpenFilters===true && 'click'}`}> */}
                ...
                {/* {
                    data.length !== 0 && <Sidebar data={props.data} 
                    currentCatData={data} 
            ...
            <div className='col-md-12 rightContent homeProducts pt-0 offset-md-1'>


                <div className='topStrip d-flex align-items-center'>
                    <p className='mb-0 p-2'>We found <span className='text-success'>{data.length}</span> items for you!</p>
                    <div className='ml-auto d-flex align-items-center'>
                        <div className='tab_ position-relative'>
                            <Button className='btn_  mx-0' onClick={() => setisOpenDropDown(!isOpenDropDown)}><GridViewOutlinedIcon /> Show: {showPerPage * 5}</Button>
                            {
